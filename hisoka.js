...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/20e57e913e43769c701d0.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 5K Sebulan` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Beli Lah Gblk, Bilang Cari Yt? Gw Tampol mulut kau')
            }
            break
            case 'chat': {
